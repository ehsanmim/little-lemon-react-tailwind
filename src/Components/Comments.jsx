...
export default function Comments() {
  ...
  return (
    <>
      ...
      <div className="glide-08 relative w-full" id="comments">
        <h3 className="mb-4 text-center text-2xl font-bold text-yellow-500">
          Comments
        </h3>
        {/*    <!-- Slides --> */}
                  ...
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          Little Lemon, is probably one of the best libraries
                          I've came across. Good looking, easy to use and above
                          all super accessible.
                        </p>
                      </blockquote>
                      <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-yellow-500">
                        <span
                        ...
                        <div className="flex items-center gap-4 pt-4 text-sm text-yellow-500">
                          <img
                ...
                <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          Little Lemon components come with proper attributes to
                ...
                <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          You can easily communicate with Little Lemon's team
